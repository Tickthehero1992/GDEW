...
/*******Functions***********/
#define GDEW_POWER_OFF EPD_W21_WriteCMD(GDEW_POWER_OFF_CMD)
#define GDEW_POWER_ON  EPD_W21_WriteCMD(GDEW_POWER_ON_CMD)
#define GDEW_POWER_ON_MESUARE EPD_W21_WriteCMD(GDEW_POWER_ON_MESURE_CMD)
#define GDEW_DEEP_SLEEP {GDEW_POWER_OFF; GDEW_BUSY(); \
	EPD_W21_WriteCMD(GDEW_DEEP_SLEEP_CMD);EPD_W21_WriteDATA(GDEW_DEEP_SLEEP_PRM);}
#define GDEW_DISPLAY_WRITE_BW EPD_W21_WriteCMD(GDEW_DISPLAY_WRITE_CMD)
#define GDEW_DISPLAY_WRITE_RED EPD_W21_WriteCMD(GDEW_DISPLAY_WRITE_RED_CMD);
#define GDEW_DATA_STOP  EPD_W21_WriteCMD(GDEW_DATA_STOP_CMD)
#define GDEW_DISPLAY_REFRESH EPD_W21_WriteCMD(GDEW_DISPLAY_REFRESH_CMD)
#define GDEW_VCOM_LUTC EPD_W21_WriteCMD(GDEW_LUTC_CMD)
#define GDEW_W2W_LUTWW EPD_W21_WriteCMD(GDEW_LUTWW_CMD)
#define GDEW_B2W_LUTBWR EPD_W21_WriteCMD(GDEW_LUTBWR_CMD)
#define GDEW_W2B_LUTWBW EPD_W21_WriteCMD(GDEW_LUTWBW_CDM)
#define GDEW_B2B_LUTBBB EPD_W21_WriteCMD(GDEW_LUTBBB_CMD)
#define GDEW_LOW_POWER_DETECTION EPD_W21_WriteCMD(GDEW_LOW_POWER_CMD)
#define GDEW_STS EPD_W21_WriteCMD(GDEW_GET_STS_CMD)
#define GDEW_READ_VCOM_VALUE EPD_W21_WriteCMD(GDEW_READ_VCOM_CMD)
#define GDEW_PARTIAL_MOD_SET EPD_W21_WriteCMD(GDEW_PRT_IN_CMD)
#define GDEW_PARTIAL_MOD_EXIT EPD_W21_WriteCMD(GDEW_PRT_OUT_CMD)
#define GDEW_PROGRAM_MODE {EPD_W21_WriteCMD(GDEW_PROGRAM_MODE_CMD);EPD_W21_WriteDATA(0XA5);}
#define GDEW_ACTIVATE_PROGRAM_OTP EPD_W21_WriteCMD(GDEW_ATV_PROGRAM_CMD)
...
void GDEW_INIT(GDEW);
uint8_t GDEW_GET_PSR(GDEW_PSR);
void GDEW_PWR_SETTINGS(GDEW_POWER);
void GDEW_POWER_OFF_SEQ(GDEW_PWR_SEQ_SET);
void GDEW_BOOST_START(GDEW_BST_STR);
void GDEW_PLL_CNTL(GDEW_PLL);
void GDEW_SELECT_T_SENS(uint8_t,int);
void GDEW_T_SENSOR_WRITE(GDEW_TEMP_SENSOR_WRITES);
void GDEW_VCOM_DATA_SETTINGS(GDEW_VCOM_DATA);
void GDEW_TCON_SETTINGS(uint8_t);
void GDEW_RESOLUTION_SETUP(uint16_t, uint8_t);
void GDEW_AUTO_MESUARE(GDEW_AUTO_MSR_VCOM);
void GDEW_VCM_DC_STN(float);
void GDEW_PARTIAL_WINDOW_SELECT(uint8_t, uint8_t ,uint16_t, uint16_t, uint8_t);
void GDEW_READ_OTP();
uint8_t GDEW_CDI(uint8_t);
uint8_t GDEW_TEMP_OFFSET(int );
void GDEW_LUT_PALET();
void GDEW_PICTURE_WRITE(uint8_t*, uint8_t*, uint8_t, uint16_t);
